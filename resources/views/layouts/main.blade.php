...
<body class="font-sans bg-gray-900 text-white" style="overflow-x: hidden">
<nav class="border-b border-gray-800">
    <div class="container mx-auto px-20 flex flex-col md:flex-row items-center justify-between py-6">
        <ul class="flex flex-col md:flex-row items-center">
            ...
            <li class="md:ml-6 mt-3 md:mt-0">
                <a href="{{url('/tv')}}" class="hover:text-gray-300">TV Shows</a>
            </li>
            <li class="md:ml-6 mt-3 md:mt-0">
        ...
        <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="https://www.gannett-cdn.com/presto/2021/03/18/USAT/c3284a14-c6d0-4254-bcda-d25677b5231c-CURRENT_BIEBER_PRESS_PHOTO_-_smaller.jpg?width=300&height=451&fit=crop&format=pjpg&auto=webp" alt="avatar" class="rounded-full w-8 h-8 object-cover">
                    </a>
                </div>
        </div>
    </div>
