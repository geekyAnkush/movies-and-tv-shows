                                ...
                                <div class="bg-gray-900 rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                            <iframe src="https://www.youtube.com/embed/{{$movie['videos']['results'][(count($movie['videos']['results'])-2 < 0)?0:count($movie['videos']['results']) - 2]['key']}}" width="560" height="315" class="responsive-iframe
